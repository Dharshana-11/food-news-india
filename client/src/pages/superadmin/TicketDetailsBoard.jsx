  ...
  return (
    ...
    >
      ...
      <Descriptions bordered column={1} size="middle">
        ...
        /** * Renders conversation messages within the ticket (optional). * Each
        message shows: * - Sender role and ID * - Message text * - Timestamp in
        localized format */
        {/* MESSAGES (OPTIONAL) */}
